      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: "customers_report/:id",
              lazy: async () => ({
                Component: (
                  await import("app/pages/reports/customerReportDetail")
                ).default,
              }),
            },
            {
            ...
            {
              path: "suppliers_report/:id",
              lazy: async () => ({
                Component: (
                  await import("app/pages/reports/supplierReportDetail")
                ).default,
              }),
            },
            {
            ...
            {
              path: "users_report/:id",
              lazy: async () => ({
                Component: (await import("app/pages/reports/usersReportDetail"))
                  .default,
              }),
            },
          ],
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              lazy: async () => ({
                Component: (
                  await import("app/pages/notification/notificationList")
                ).default,
              }),
            },
          ],
