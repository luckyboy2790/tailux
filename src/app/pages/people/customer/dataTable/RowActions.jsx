...
export function RowActions({ row, table }) {
  ...
  const confirmMessages = {
    pending: {
      description: t("nav.customer.confirmDelete.pending.description"),
    },
    success: {
      title: t("nav.customer.confirmDelete.success.title"),
    },
  };
  ...
  const handleDeleteRows = async () => {
    ...
    const response = await fetch(
      `${API_URL}/api/customer/delete/${row.original?.id}`,
      {
        method: "POST",
      },
    );
    ...
    if (!response.ok) {
      toast.error(t("nav.customer.confirmDelete.failed.title"));
    ...
    toast.success(t("nav.customer.confirmDelete.success.title"));
