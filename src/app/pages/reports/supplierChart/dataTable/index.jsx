...
export default function PurchaseTable() {
  ...
  const [filters, setFilters] = useLocalStorage("supplierReportTableFilters", {
    pageIndex: 0,
    pageSize: 10,
    globalFilter: "",
  });
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-supplierReportTable-1",
    {},
  );

  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-supplierReportTable-1",
    {},
  );
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${API_URL}/api/report/suppliers?${queryString}`,
        );
                          ...
                          <Tr>
                            ...
                            <Td>
                              ...
                              {table
                                ...
                                .rows.reduce(
                                  (acc, row) =>
                                    acc + row.original.total_purchases || 0,
                                  0,
                                )
                                .toLocaleString()}
                            </Td>
                            <Td>
                              ...
                              {table
                                ...
                                .rows.reduce(
                                  (acc, row) =>
                                    acc + Number(row.original.total_amount),
                                  0,
                                )
                                .toLocaleString()}
                            </Td>
