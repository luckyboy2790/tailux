...
import PurchaseReportDetail from "./purchaseReportSection";

const UsersReportDetail = () => {
  const { t } = useTranslation();
  const breadcrumbs = [
    { title: t("nav.report.report"), path: "/report" },
    {
      title: t("nav.report.users_report"),
      path: "/report/users_report",
    },
...
export default UsersReportDetail;
