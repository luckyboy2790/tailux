...
export function RowActions({ row, table }) {
  ...
  const confirmMessages = {
    pending: {
      description: t("nav.category.confirmDelete.pending.description"),
    },
    success: {
      title: t("nav.category.confirmDelete.success.title"),
    },
  };
  ...
  const handleDeleteRows = async () => {
    ...
    const response = await fetch(
      `${API_URL}/api/category/delete/${row.original?.id}`,
      {
        method: "POST",
      },
    );
    ...
    if (!response.ok) {
      toast.error(t("nav.category.confirmDelete.failed.title"));
    ...
    toast.success(t("nav.category.confirmDelete.success.title"));
