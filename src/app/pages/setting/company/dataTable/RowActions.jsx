...
export function RowActions({ row, table }) {
  ...
  const confirmMessages = {
    pending: {
      description: t("nav.company_fields.confirmDelete.pending.description"),
    },
    success: {
      title: t("nav.company_fields.confirmDelete.success.title"),
    },
  };
  ...
  const handleDeleteRows = async () => {
    ...
    const response = await fetch(
      `${API_URL}/api/company/delete/${row.original?.id}`,
      {
        method: "POST",
      },
    );
    ...
    if (!response.ok) {
      toast.error(t("nav.company_fields.confirmDelete.failed.title"));
    ...
    toast.success(t("nav.company_fields.confirmDelete.success.title"));
